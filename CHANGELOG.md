...
* Fixed: The troubleshooting functions were not loaded in the remoting session (Register-LauncherPSRemotingTroubleshootingFunction)
...
* Fixed: Rename default built-in variables in Show-Object to avoid conflicts
