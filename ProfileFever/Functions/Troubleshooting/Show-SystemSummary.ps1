...
function Show-SystemSummary
{
    ...
    try
    {
        ...
        [void] $summary.AppendFormat('   {0} 󰓯 {1}  {2}  {3} 󰚗 {4:0}GB 󰋊 {5:0}GB', $queryResult.OperatingSystem.Version, $queryResult.OperatingSystem.Architecture, $queryResult.OperatingSystem.Language, $queryResult.ProcessorCount, $queryResult.MemorySize, $queryResult.SystemDiskSize).AppendLine()
        [void] $summary.AppendLine()
